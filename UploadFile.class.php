<?php
   ...
   */
  class UploadFile{
    private $max_size   = '200000000'; //设置上传文件的大小，此为2M
     ...
     */
    public function __construct($rand_name=true, $save_path='./upload/', $allow_type='', $callback = ''){
    ...
    */
    ...
    public function get_msg(){
	  ...
	  $res['originname'] = $this->file_name;
	  $res['filename'] = $this->new_name;
	  $res['size'] = $this->file_size;
      $res['imgurl'] = $this->uploaded;
